...
urlpatterns = [
    ...
    path('projects/status_report/source/<int:project_deliver_id>', views.project_list_statuses_report_view, name='deliver_project_list_status_report'),
    path('projects/status_report/<int:project_deliver_id>/<int:company_id>', views.project_list_statuses_report_view, name='company_deliver_project_list_status_report'),
